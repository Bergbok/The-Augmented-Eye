...
- [Installation & Setup](#table-of-contents)
  ...
  - [Setting up emails](#setting-up-emails)
    - [Edit sendmail.ini](#edit-sendmailini)
    - [Edit php.ini](#edit-phpini)
    - [If you plan on using a Gmail email](#if-you-plan-on-using-a-gmail-email) 
  - [Enabling mod_rewrite](#enabling-mod_rewrite)
  - [Setting up FileZilla (FTP)](#setting-up-filezilla-ftp-)
  - [Setting up database (MySQL)](#setting-up-database-mysql)
  - [Moving files to appropriate locations](#moving-files-to-appropriate-locations)
- [How To Use](#how-to-use)
  - [Features](#features)   
- [Error Handling](#error-handling)
  - [Unable to connect](#unable-to-connect)
  - [Pictures not showing](#pictures-not-showing)
  - [Database errors](#database-errors)
- [Style Guide Followed](#style-guide-followed)
- [Features I would've liked to implement](#features-i-wouldve-liked-to-implement)
