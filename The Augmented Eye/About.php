    ...
    <body>
        <div class="centered-column pixel-text">
            ...
            <div class="article-text">
                <p> One of the project options for a PHP course I did was to create a news website, at the time I was playing through VA-11 HALL-A and I thought recreating The Augmented Eye could be more fun than simply creating a basic news website with no personality. </p>
            ...
            <div id="staff">
                ...
                <figure id="donovan" class="center staff-border">
                    ...
                    <hr>
                    <figcaption class="centered-text"><a href="/The Augmented Eye/Profile.php?profileID=3"> Donovan D. Dawson </a></figcaption>
                    <hr>
                ...
                <figure id="kimberly" class="center staff-border">
                    ...
                    <hr>
                    <figcaption class="centered-text"><a href="/The Augmented Eye/Profile.php?profileID=1"> Kimberly La Vallete </a></figcaption>
                    <hr>
                ...
                <figure id="lana" class="center staff-border">
                    <figcaption style="padding-top: 10px;" class="centered-text"><a href="/The Augmented Eye/Profile.php?profileID=2"> Lana Smithee </a></figcaption>
                    <hr>
                    <p class="centered-text"> Writer(s) </p>
                    <p style="padding:15px;"> You don't really think Lana Smithee is just one person, do you? - <a href="/The Augmented Eye/Profile.php?profileID=3"> Donovan D. Dawson </a></p>
                </figure>
                <br>
            </div>
        </div>
