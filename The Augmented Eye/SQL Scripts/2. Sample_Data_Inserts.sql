...
VALUES('1','Mass emigration continues as QUINCY reveals new economic adjustments',@content,'2077-12-13 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','"Wonderlanders" are the newest threat to your security',@content,'2077-12-13 12:15:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','Cyborg in Heels returns next year to the Super Silver Thunder Dome',@content,'2077-12-13 12:30:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','Local woman, Local hero',@content,'2077-12-14 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','70% of our readers consider shrimp ramen to be "disgusting"',@content,'2077-12-14 12:15:00');
...
01001111';
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','I think Alice_Rabbit might a a dog...',@content,'2077-12-14 12:30:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','Riots intensify as we approach Megachristmas',@content,'2077-12-14 12:45:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','Tokyo Flu Treatment nowhere to be found',@content,'2077-12-14 13:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','Neo-San Francisco rocked by a powerful earthquake, millions saved',@content,'2077-12-15 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('3','KIRA mIKI CONFIRMED AS THE BEST POP STAR IN HISTORY!!',@content,'2077-12-15 12:15:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('3','Interview: GLO-RI-A Light and her quest for a Tino Award.',@content,'2077-12-15 12:30:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','Quincy: One more civil death and we''ll ban protests',@content,'2077-12-15 12:45:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('1','Is Alice Rabbit a group? The answer here',@content,'2077-12-15 13:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('3','FUUUUUUCK THE WOOOORLD',@content,'2077-12-16 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('3','Crime rate up 5% this month',@content,'2077-12-16 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','Men prefer “Christmas Cakes”, study reveals',@content,'2077-12-20 12:00:00');
...
INSERT INTO Articles(articleAuthorID, articleTitle, articleContent, articlePublishDate)
VALUES('2','QUINCY studies the possibility of allowing imports',@content,'2077-12-23 12:00:00');
