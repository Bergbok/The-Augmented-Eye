...
function validate_login(): bool {
    ...
    if (isset($_SERVER['REQUEST_METHOD'])){
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){                
            ...
            if (isset($_POST['user_Email']) && $_POST['user_Email'] != null) {
                $user_Email_isvalid = true;
                if ($show_provided_login_info){
                    echo '<p class=\'centered-text\'> Provided name is: ' . $_POST['user_Email'] . '</p>';
                }
            } elseif ($show_login_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your email </p>';   
            }

            if (isset($_POST['user_Password']) && $_POST['user_Email'] != null) {
                $user_Password_isvalid = true;
                if ($show_provided_login_info){
                    echo '<p class=\'centered-text\'> Provided password is: ' . $_POST['user_Password'] . '</p>';
                }
            } elseif ($show_login_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your password </p>';
            }
        ...
        if ($_SERVER['REQUEST_METHOD'] == 'POST'){                
            ...
            if (isset($_POST['newuser_Name']) && $_POST['newuser_Name'] != null) {
                ...
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided name is: ' . $_POST['newuser_Name'] . '</p>';
                }
            ...
            if (isset($_POST['newuser_Surname']) && $_POST['newuser_Surname'] != null) {
                ...
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided surname is: ' . $_POST['newuser_Surname'] . '</p>';
                }
            } elseif ($show_registration_errors) {
            ...
            if (isset($_POST['newuser_Gender']) && $_POST['newuser_Gender'] != null) {
                ...
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided gender is: ' . $_POST['newuser_Gender'] . '</p>';
                }
            } elseif ($show_registration_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your gender </p>';
            }

            if (isset($_POST['newuser_Birthday']) && $_POST['newuser_Birthday'] != null) {
                $newuser_birthday_isvalid = true;
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided birthday is: ' . $_POST['newuser_Birthday'] . '</p>';
                }
            } elseif ($show_registration_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your birthday </p>';
            }

            if (isset($_POST['newuser_Email']) && $_POST['newuser_Email'] != null) {
                $newuser_email_isvalid = true;
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided e-mail is: ' . $_POST['newuser_Email'] . '</p>';
                }
            } elseif ($show_registration_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your e-mail </p>';
            }

            if (isset($_POST['newuser_Contact']) && $_POST['newuser_Contact'] != null) {
                $newuser_contact_isvalid = true;
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided contact is: ' . $_POST['newuser_Contact'] . '</p>';
                }
            } elseif ($show_registration_errors) {
                echo '<p class=\'centered-text error-message\'> Please enter your contact information </p>';
            }
            
            if (isset($_POST['newuser_ReceiveNewsletter']) && $_POST['newuser_ReceiveNewsletter'] != null) {
                if ($show_provided_registration_info){
                    echo '<p class=\'centered-text\'> Provided newsletter choice is: ' . $_POST['newuser_ReceiveNewsletter'] . '</p>';
                }
            } 
